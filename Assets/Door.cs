...
public class Door : MonoBehaviour
{
  ...
  public float start_dist_or_angle;
  ...
  public GameObject interaction_image;
    ...
    void Update()
    {
      if(open_close_ON)
      {
        float angleDoor = start_dist_or_angle;
        if(is_open) angleDoor = start_dist_or_angle + open_dist_or_angle;
        if(open_type == open_type_ENUM.move_to_open)
        {
          if(door_axis == door_axis_ENUM.X)
          {
            float posX = Mathf.MoveTowards(transform.localPosition.x, angleDoor, open_speed * Time.deltaTime);
          ...
          {
            float posY = Mathf.MoveTowards(transform.localPosition.y, angleDoor, open_speed * Time.deltaTime);
          ...
          {
            float posZ = Mathf.MoveTowards(transform.localPosition.z, angleDoor, open_speed * Time.deltaTime);
        ...
        else
        {
          if(door_axis == door_axis_ENUM.X)
          {
            float angleX = Mathf.MoveTowardsAngle(transform.localEulerAngles.x, angleDoor, open_speed * Time.deltaTime);
          ...
          {
            float angleY = Mathf.MoveTowardsAngle(transform.localEulerAngles.y, angleDoor, open_speed * Time.deltaTime);
          ...
          {
            float angleZ = Mathf.MoveTowardsAngle(transform.localEulerAngles.z, angleDoor, open_speed * Time.deltaTime);
